...
def prev_url(target, calendar, period):
    ...
    return mark_safe('<a href="%s%s" id="id_prev"><span class="icon-arrow-previous" style="color:#f16e00; margin-right:40px"></span></a>' % (
...
def next_url(target, calendar, period):
    ...
    return mark_safe('<a href="%s%s"><span class="icon-arrow-next" style="color:#f16e00;margin-left:40px"></span></a>' % (
        reverse(target, kwargs={'calendar_slug': slug}),
